...
public class IntIncDec extends StelContainer {
    public IntIncDec(SFontIfc someFont, STexture texUp, STexture texDown, int someMin, int someMax, int initValue, int someInc) {
        min = someMin;
        max = someMax;
        value = initValue;
        inc = someInc;
        ...
        label = new StelLabel();
        if (someFont != null) label.setFont(someFont);
        label.setSize(30, 10);
        label.setPos(9, 2);
        btmore = new TexturedButton(texUp);
        btmore.setSize(8, 8);
        btmore.setPos(0, 0);
        ...
        btless = new TexturedButton(texDown);
        btless.setSize(8, 8);
        btless.setPos(0, 7);
